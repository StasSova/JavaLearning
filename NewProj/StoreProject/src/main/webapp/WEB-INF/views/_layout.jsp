        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <%= "home.jsp".equals( pageBody ) ? "active" : ""%>" aria-current="page"
                           href="<%=contextPath%>/">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <%= "web_xml.jsp".equals( pageBody ) ? "active" : ""%>"
                           href="<%=contextPath%>/web-xml">WebXml</a>
                    </li>
                    <li class="nav-item">
